...
export const UserProfile = () => {
  ...
  return (
    <>
            ...
            <div className="flex flex-col gap-4 flex-1">
              ...
              <div className="flex gap-8">
                <div className="flex flex-col items-start">
                  <span className="text-sm font-semibold text-text cursor-pointer" onClick={() => handleTypeClick("followers")}>{viewedUser?.followers?.length || 0}</span>
                ...
                <div className="flex flex-col items-start">
                  <span className="text-sm font-semibold text-text cursor-pointer" onClick={() => handleTypeClick("followings")}>{viewedUser?.followings?.length || 0}</span>
      ...
      {type && (
        <FollowersModal isOpen={Boolean(type)} onClose={() => setType(null)} userId={viewedUser._id} type={type}/>
      )}
    </>
  );
};